...
var main = (function () {
	function main() {
		...
		var tinder = new TinderService();
		tinder.getPeople().then(this.getPeopleSuccess.bind(this));
	}

	_createClass(main, [{
		key: 'getPeopleSuccess',
		value: function getPeopleSuccess(e) {
			_.each(e, function (result, index) {
				console.log('got: ', result);
				var img = new Image();
				var div = document.createElement('div');
				div.innerHTML = [result._id, result.bio, result.name].join('<br/>');
...
},{"./services/TinderService":2,"underscore":7}],2:[function(require,module,exports){
'use strict';
...
var TinderService = (function () {
	function TinderService() {
		_classCallCheck(this, TinderService);

		this.url = '/tinder';
	}

	_createClass(TinderService, [{
		key: 'getPeople',
   ...
   */
		value: function getPeople() {
			return qajax({ url: this.url, method: 'GET' }).then(qajax.filterSuccess).then(qajax.toJSON);
		}
	}, {
		key: 'like',
...
},{"q":4,"qajax":5}],3:[function(require,module,exports){
...
},{"./qajax":6,"q":4}],6:[function(require,module,exports){
/*
